...
namespace Examples
{
    public class CheckoutSessionExamples
    {
        ...
        public CheckoutSessionExamples()
        {
            ...
            // username to be authenticated on the gateway (using the ones from recent changes)
            string username = "";
        ...
        public void CreateCheckoutSession()
        {
            ...
            if (result.Result == Result.Success)
            {
                ...
                // Print both standard request properties and new session properties
                Console.WriteLine(" URL: " + result.Url);
                Console.WriteLine(" Payment Request ID: " + result.PaymentRequestId);
